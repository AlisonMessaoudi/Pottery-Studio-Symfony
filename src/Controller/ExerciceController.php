...
{
    /**
     * @Route("/exercices", name="exercice_conversion")
     */
    public function exercice_conversion(): Response
    {
        // Requete
        $users = [ 'victor', 'john', 'paul' ];
        $date = new DateTime();

        return $this->render('exercices/exercice.conversion.html.twig', [
            'users' => $users,
            'date' => $date,
            'prix' => 10.99,
        ]);
    ...
    /**
     * @Route("/exercices", name="exercice_liste")
     */
    public function exercice_liste() {
        ...
        return $this->render('exercices/exercice.liste.html.twig', [
            'personnes' => $personnes
        ]);
    }
}
