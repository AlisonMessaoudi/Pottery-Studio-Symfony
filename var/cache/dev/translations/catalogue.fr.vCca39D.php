...
$catalogue = new MessageCatalogue('fr', array (
  ...
  'messages' => 
  array (
    'page.contact.title' => 'Contactez-nous maintenant',
    'page.contact.subtitle' => 'Nous répondons 24h/24',
    'page.contact_pro.title' => 'Contactez-nous maintenant, les pros ;)',
    'page.contact_pro.subtitle' => 'Nous répondons 24h/24 voir plus',
    'email.contact.subject' => 'Demande de contact (Victor)',
    'email.contact.title' => 'Vous avez reçu un message',
    'email.contact.text' => 'Bonjour, vous avez reçu un message de la page de ....',
    'email.registration.subject' => 'Validez votre inscription',
  ),
));
