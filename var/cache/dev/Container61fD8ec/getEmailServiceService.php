...
class getEmailServiceService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['App\\Service\\EmailService'] = new \App\Service\EmailService(new \Symfony\Component\Mailer\Mailer((new \Symfony\Component\Mailer\Transport(new RewindableGenerator(function () use ($container) {
        ...
        }, 5)))->fromStrings(['main' => $container->getEnv('MAILER_DSN')]), NULL, ($container->services['event_dispatcher'] ?? $container->getEventDispatcherService())), $container->getEnv('ADMIN_EMAIL'), '%APP_ENV', ($container->services['translator'] ?? $container->getTranslatorService()));
    }
}
